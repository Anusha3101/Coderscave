...
public class ECommerceWebsite1 {
    ...
    private static void initializeProducts() {
        products.add(new Product("Tv", 50000));
        products.add(new Product("Headphones", 10000));
        products.add(new Product("Car", 800000));
        products.add(new Product("Computer", 90000));
        products.add(new Product("Shoes", 5000));
        products.add(new Product("Bike", 199999));
    ...
    private static void browseProducts() {
        ...
        // Loops until it gets all available products which are instantiated in above
        // method
